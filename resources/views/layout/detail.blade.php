				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							<div class="wrap-slick3-dots"><ul class="slick3-dots" role="tablist" style=""><li class="slick-active" role="presentation"><img src="  {{asset('storage/' . $data->image)}} ">
                            <div class="slick3-dot-overlay"></div></li><li role="presentation"><img src=" {{asset('storage/' . $data->image)}} "><div class="slick3-dot-overlay"></div></li><li role="presentation"><img src=" {{asset('storage/' . $data->image)}} ">
                            <div class="slick3-dot-overlay"></div></li></ul></div>
